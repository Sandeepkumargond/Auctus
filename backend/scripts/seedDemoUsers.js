...
const demoUsers = [
    {
        userName: "Auctus Admin",
        email: "admin@auctus.local",
        password: "Auctus@123",
        phone: "9000000001",
        address: "Auctus admin workspace",
        role: "Super Admin",
        kycStatus: "Approved",
...
try {
    ...
    for (const demoUser of demoUsers) {
        ...
        if (demoUser.email === "bidder@auctus.local") {
